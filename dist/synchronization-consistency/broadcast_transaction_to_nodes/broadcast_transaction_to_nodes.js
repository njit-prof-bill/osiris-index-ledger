...
const node_list = [
    new sync.TransactionIdList({ transaction_list: [
...
export const BroadcastTransaction = (request, response) => {
    try {
        const get_transaction = request.request.transaction_id; // actual string
        const new_transaction = new sync.TransactionId({ transaction_id: get_transaction }); // converting actual string into TransactionId object
